...
<body>
  ...
  <li class="active">Estado Actualizar Cargo</li>
</ul>
</div>
<div class="row-fluid">
<h3 class="titleServic"></h3>
		...
		<!--Codigo PHP-->
		 <?php
						...
						$consulta = "UPDATE cargos SET nombre_cargo='$cargo', funciones='$funciones' WHERE id='$idCargo'";

						if(mysqli_query($link,$consulta))
{
echo "<center>Cargo Actualizado Exitosamente</center>";
}
else{
