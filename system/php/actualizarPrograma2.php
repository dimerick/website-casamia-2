...
<body>
  ...
  <li class="active">Estado Actualizacion</li>
</ul>
</div>
<div class="row-fluid">
...
$consulta = "UPDATE programas SET nombre='$programa', duracion='$duracion', descripcion='$descripcion'";

				
if(mysqli_query($link,$consulta))
{
echo "<center>Programa Actualizado Exitosamente</center>";
}
else{
