...
<body>
  ...
  <li><a href="../crearArea.html">Crear Area</a> <span class="divider">/</span></li>
  <li class="active">Estado Creacion Areas</li>
</ul>
</div>
<div class="row-fluid">
...
{
echo "<center>Area registrada exitosamente</center>";
}
else{
