...
<div class="row-fluid">
<h3 class="titleServic">Crear Cargo</h3>
</div>
		...
		<!--Codigo PHP-->
                    ...
                    <form role="form" action="crearCargo2.php" enctype="multipart/form-data" name="registroUsuarios" method="post" onsubmit="return comprobarFormulario()">
						...
						<label for="rol">Area ala que pertenece *</label>
                            ...
                            $consulta = "SELECT id, area FROM areas ORDER BY area DESC";
							...
							echo '<div class="input-group"><label for="rol">Persona encargada *</label><select class="form-control" name="encargado">';
                            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
