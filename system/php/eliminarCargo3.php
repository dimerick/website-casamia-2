...
<body>
  ...
  <li class="active">Estado Eliminar Cargo</li>
</ul>
</div>
<div class="row-fluid">
...
$consulta = "INSERT cargos_retirados SELECT * FROM cargos WHERE id = '$idCargo';";
$consulta .= "DELETE FROM cargos WHERE id = '$idCargo'";
