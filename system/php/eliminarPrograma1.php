...
<body>
  ...
  <li class="active">Eliminar Programa</li>
</ul>
</div>
<div class="row-fluid">
<h3 class="titleServic">Eliminar Programa</h3>
</div>
...
echo "<h3>Realmente desea eliminar el programa:</h3> </br></br><b>Programa: </b>".$row["nombre"].'</br>';
echo '<form action="eliminarPrograma2.php" method="post">
