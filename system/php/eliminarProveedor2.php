...
<body>
  ...
  <li class="active">Estado eliminar proveedor</li>
</ul>
</div>
<div class="row-fluid">
...
$consulta = "INSERT proveedores_eliminados SELECT * FROM proveedores WHERE id = '$id';";
$consulta .= "DELETE FROM proveedores WHERE id = '$id'";
if($result = mysqli_multi_query($link,$consulta)){
echo "<center><h4>Eliminacion Exitosa</h4></center>";
}
else{
